...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearSignupUseCase(viewManagerModel, clearViewModel, userDataAccessObject);
    ...
    private static ClearController createClearSignupUseCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface clearUserDataAccessInterface) throws IOException {
